...
public class item extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           Cart c1=(Cart) k.getAttribute("cart");
           
           String p1=request.getParameter("t1");
           float  price=new Float(request.getParameter("t2").trim());
           String pid=request.getParameter("t3");
           
           boolean b= c1.addProduct(p1, price, pid);
           if(b){
               ...
               out.println("<html>");
               out.println("<body>");
               out.println("Sorry Could not add item.");
