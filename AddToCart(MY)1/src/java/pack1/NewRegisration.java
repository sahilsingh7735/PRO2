 ...
 * @author SKB
 */
@WebServlet(name = "NewRegisration", urlPatterns = {"/NewRegisration"})
public class NewRegisration extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(pass.equals(pass2)){
                ...
                try{
                     ...
                     Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/mysql","root","soumik");
                     String q1 ="Insert into stud1 values(?,?,?,?,?,?);";
